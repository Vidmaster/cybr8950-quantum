...
%Maybe move to goals section? TODO: Scattered focus
...
In other words, the main force of modern warfare is information transmission, or we can call it information warfare. % I hate this sentence
In this case, it is extremely important to properly and securely transmit information between the agent and commander. % Not a fan of this either
...
\subsection{Contemporary Quantum Communication and Cryptography} % TODO: Move all this over to methodology and fix the layout because it sucks
...
Next, implementing the quantum portion of the algorithm should be less difficult with the scaffolding built. % TODO Not sure I love this sentence
...
In this paper we have explored the impacts of quantum computing on classical cryptography, examined the current state of the art of quantum cryptography, implemented and analyzed Amerimehr and Dehkordi's 2018 symmetric quantum encryption algorithm\cite{amerimehr_quantum_2018}, and presented a generalized process for the implementation of quantum cryptographic algorithms. % TODO Break out for readability? Semicolons?
The impacts of quantum computing on today's cryptographic systems are well understood, and efforts are being made by NIST to select suitable replacements for vulnerable public-key encryption, key-establishment, and signature algorithms\cite{moody_nist_2020, csd_postquantum_2017}. We identified promising quantum algorithms for important aspects of cryptography, including as TODO for key distribution, TODO for integrity, TODO for encryption, and TODO for non-repudiation. % TODO Call out that these aren't necessarily ready for the big leagues but serve as promising options
