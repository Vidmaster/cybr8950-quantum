...
|-------------------|---------|---------------------------|-------------|
|Gantt Chart Tool (Moday.com)| Yes | Zexi | A project management tool that enables organizations to manage tasks, projects, and team work.  |
|??? | Yes | Henry | ??? |
|??? | Yes | Casey | ??? |
|??? | Yes | Byran | ??? |
